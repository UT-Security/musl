...
static pool_t tlsf_get_pool(tlsf_t tlsf)
{
...
**   contents undefined
*/
static void* tlsf_realloc(tlsf_t tlsf, void* ptr, size_t size)
{
	control_t* control = tlsf_cast(control_t*, tlsf);
	void* p = 0;
...
int __libc_tlsf_remap(void* ptr, size_t size, size_t new_size)
{
    (void) ptr;
    (void) size;
    (void) new_size;
